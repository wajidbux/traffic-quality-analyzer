...
import { addManualRecord, countRecords, deleteAllRecords, guessColumnMap, importRecords, listRecords, parseCsv, } from "../services/importer.js";
import { getSetting, setSetting } from "../db/database.js";
import { maskRecord } from "../utils/masking.js";
import { asyncHandler } from "../utils/asyncHandler.js";
export function recordsRouter(_context) {
    const router = Router();
    const mask = async (rows) => {
    ...
    router.post("/guess-columns", asyncHandler(async (req, res) => {
    ...
    router.post("/import", asyncHandler(async (req, res) => {
        ...
        try {
            ...
            if (previous !== null)
                await setSetting("dedupe_on_import", previous);
