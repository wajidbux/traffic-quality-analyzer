...
import {
  ...
  quotaLevel,
  recordQuotaError,
} from "../services/quotaManager.js";
import { PixalateApiError } from "../pixalate/types.js";
import { audit } from "../services/auditLogger.js";
import { logger } from "../utils/logger.js";
import { asyncHandler } from "../utils/asyncHandler.js";

export function ctvRouter(context: AppContext): Router {
  const router = Router();
  ...
  router.get(
    ...
    asyncHandler(async (_req, res) => {
      ...
      let ctvQuota: ReturnType<typeof context.ctvClient.getQuota> extends Promise<infer T> ? T | null : null = null;
